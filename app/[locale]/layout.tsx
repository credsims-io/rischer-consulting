    ...
    <html lang="en" className={`${poppins.className} ${playfair.className}`}>
      ...
      <body className={`${poppins.variable} ${playfair.variable} font-poppins`}>
        ...
        <Script id="apollo-tracker" strategy="afterInteractive">
          {`function initApollo(){var n=Math.random().toString(36).substring(7),o=document.createElement("script");o.src="https://assets.apollo.io/micro/website-tracker/tracker.iife.js?nocache="+n,o.async=!0,o.defer=!0,o.onload=function(){window.trackingFunctions.onLoad({appId:"69f9154506d576000de37ba0"})},document.head.appendChild(o)}initApollo();`}
        </Script>
      </body>
    </html>
  );
